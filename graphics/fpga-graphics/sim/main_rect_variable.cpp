// Project F: FPGA Graphics - Rect_variable Verilator C++
...
int main(int argc, char* argv[]) {
    ...
    sdl_window = SDL_CreateWindow("Rectangle", SDL_WINDOWPOS_CENTERED,
    ...
    Vtop_rect_variable* top = new Vtop_rect_variable;
